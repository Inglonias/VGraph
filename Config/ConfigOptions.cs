...
namespace VGraph.Config
{
    public class ConfigOptions
    {
        ...
        private string PrettySerialize()
        {
            ...
            rValWriter.WriteLine("    \"BackgroundPaperColorString\":\"" + BackgroundPaperColor.ToString() + "\",");
            rValWriter.WriteLine("    \"BorderLinesColorString\":\"" + BorderLinesColor.ToString() + "\",");
            rValWriter.WriteLine("    \"CenterLinesColorString\":\"" + CenterLinesColor.ToString() + "\",");
            rValWriter.WriteLine("    \"CursorColorString\":\"" + CursorColor.ToString() + "\",");
            rValWriter.WriteLine("    \"DefaultLineColorString\":\"" + DefaultLineColor.ToString() + "\",");
            rValWriter.WriteLine("    \"GridLinesColorString\":\"" + GridLinesColor.ToString() + "\",");
            rValWriter.WriteLine("    \"SelectionBoxColorString\":\"" + SelectionBoxColor.ToString() + "\",");
            rValWriter.WriteLine("    \"LineHighlightColorString\":\"" + LineHighlightColor.ToString() + "\",");
